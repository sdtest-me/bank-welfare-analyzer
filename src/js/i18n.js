(function () {
  const tr = {
    ru: {
      ...
      rankTitle:"🏁 Рейтинг банков",rankInputLabel:"Массив банков (JSON или по одной JSON-строке)",rankInputHint:"Поддерживается JSON-массив или несколько строк JSON (один банк на строку).",btnRank:"📋 Построить рейтинг",rankRisk:"Риск",rankMismatch:"Расхождение",rankEmpty:"Добавьте хотя бы один банк для сравнения.",rankParseErr:"Не удалось прочитать ввод. Используйте JSON-массив или JSON по строкам.",rankImpactTitle:"Практическое влияние",rankImpactIndex:"Индекс влияния",rankReputationRisk:"Репутационный риск",rankStageGap:"Разрыв стадий",rankShortTermImpact:"Краткосрочный эффект",rankLongTermImpact:"Долгосрочный эффект",impactRiskLow:"низкий",impactRiskMedium:"средний",impactRiskHigh:"высокий",compareModeLabel:"Включить сравнительный режим (3–5 банков)",compareModeHint:"Выберите 3–5 демо-банков для быстрого сравнения бок о бок.",compareRangeErr:"Для сравнительного режима нужно выбрать от 3 до 5 банков.",compareNarrativeLead:"Лидер по совокупному профилю:",compareNarrativeGap:"Наибольший стратегический разрыв у:",compareNarrativeAvg:"Среднее расхождение по выборке:",rankWelfare:"Давление на благополучие",rankGovernance:"Управленческий профиль"
    },
    en: {
