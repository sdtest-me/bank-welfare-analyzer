(function () {
  const tr = {
    ru: {
      ...
      sponsorLead:"Ограничение демо: этот анализ основан на официальных и оценочных данных.",
    ...
    en: {
      ...
      sponsorLead:"Demo limitation: this analysis is based on official and estimated data.",
